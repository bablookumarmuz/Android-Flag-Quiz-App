...
class FlagsDao {
    ...
    fun getRandomTenRecords(helper: DatabaseCopyHelper): ArrayList<FlagsModel> {
        ...
        val idIndex = cursor.getColumnIndexOrThrow("flag_id")
        val countryNameIndex = cursor.getColumnIndexOrThrow("country_name")
        val flagNameIndex = cursor.getColumnIndexOrThrow("flag_name")
